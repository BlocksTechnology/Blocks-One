...
// This configuration file contains the ibasic settings.
...
#define STRING_CONFIG_H_AUTHOR "(Blocks One)" // Who made the changes.
...
//The value is the delay to turn the servo off after powered on - depends on the servo speed; 300ms is good value, but you can try loer it.
...
#define HOMING_FEEDRATE {2000, 2000, 1000, 0}  //{50*60, 50*60, 4*60, 0} set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 400,97}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {250, 250, 10, 80}    // (mm/sec)
...
#define FILAMENT_UNLOAD_RETRACTION_LENGTH 700

#define PREHEAT_HOTEND_TEMP 180
