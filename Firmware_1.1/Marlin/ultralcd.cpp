...
#ifndef WITBOX //WITBOX dont have control of power suply
	#if PS_ON_PIN > -1
		if (powersupply)
		{
...
void lcd_level_bed()
{
    ...
    switch(pageShowInfo){
     ...
     case 6:
        ...
        {     
          lcd.setCursor(0, 1);
          lcd_printPGM(PSTR("Insert filament"));
		  lcd.setCursor(0, 2);
        ...
        {     
          lcd.setCursor(0, 1);
          lcd_printPGM(PSTR("Press after"));
		   lcd.setCursor(0, 2);
          lcd_printPGM(PSTR("filament purged."));
              currentMenu = lcd_level_bed;
           ChangeScreen=false;         
        }
...
static void select_extruder_load(){
    ...
    MENU_ITEM(submenu, MSG_EXTRUDER_1, lcd_load_material_extrud_check1);
